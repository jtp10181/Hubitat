...
metadata {
	definition (
		name: "Universal Z-Wave Dimmer",
		namespace: "jtp10181",
		author: "Jeff Page (@jtp10181)",
		singleThreaded: true,
		importUrl: "https://raw.githubusercontent.com/jtp10181/Hubitat/main/Drivers/universal/universal-zwave-dimmer.groovy"
	) {
		capability "Actuator"
		capability "Switch"
		...
		fingerprint mfr:"001D", prod:"0041", deviceId:"0002", inClusters:"0x00,0x00", controllerType: "ZWV" //Leviton ZW6HD Dimmer
	}
...
def setLevel(Number level, Number duration=null) {
...
def startLevelChange(direction, duration=null) {
	...
	logDebug "startLevelChange($direction) for " + (durationVal==255 ? "default duration" : "${durationVal}s")
