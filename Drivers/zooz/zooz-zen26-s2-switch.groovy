...
metadata {
	definition (
		name: "Zooz ZEN26 S2 Switch 3.0",
		namespace: "jtp10181",
		author: "Jeff Page / Kevin LaFramboise (@krlaframboise)",
		importUrl: "https://raw.githubusercontent.com/jtp10181/hubitat/master/Drivers/zooz/zooz-zen26-s2-switch.groovy"
	) {
		capability "Actuator"
		capability "Sensor"
		capability "Switch"
...
Map getLedIndicatorParam() {
	return getParam(2, "LED Indicator (ZEN26)", 1, 0, ledIndicatorOptions)
}
...
Map getSceneControlParam() {
	//ZEN21=9, ZEN26=10
	return getParam(10, "Scene Control Events", 1, 0, disabledEnabledOptions)
}
