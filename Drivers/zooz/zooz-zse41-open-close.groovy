...
@Field static final Map deviceModelNames = ["7000:E001":"ZSE41"]

metadata {
	definition (
		name: "Zooz ZSE41 Open-Close XS Sensor",
		namespace: "jtp10181",
		author: "Jeff Page (@jtp10181)",
		singleThreaded: true,
		importUrl: "https://raw.githubusercontent.com/jtp10181/Hubitat/main/Drivers/zooz/zooz-zse41-open-close.groovy"
	) {
		capability "Sensor"
		...
		fingerprint mfr:"027A", prod:"7000", deviceId:"E001", inClusters:"0x5E,0x85,0x8E,0x59,0x55,0x86,0x72,0x5A,0x73,0x80,0x9F,0x71,0x87,0x30,0x70,0x84,0x6C,0x7A", controllerType: "ZWV" //Zooz ZSE41 Open-Close Sensor
	}
...
[
	ledMode: [ num:1, 
		...
		size: 1, defaultVal: 1, 
		options: [1:"LED Blinks with Status Change", 0:"LED Disabled"]
	],
