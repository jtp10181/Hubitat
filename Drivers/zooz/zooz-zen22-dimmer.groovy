...
metadata {
	definition (
		name: "Zooz ZEN22 Dimmer 4.0",
		namespace: "jtp10181",
		author: "Jeff Page / Kevin LaFramboise (@krlaframboise)",
		importUrl: "https://raw.githubusercontent.com/jtp10181/hubitat/master/Drivers/zooz/zooz-zen22-dimmer.groovy"
	) {
		capability "Actuator"
		capability "Sensor"
		capability "Switch"
		...
		fingerprint mfr:"027A", prod:"B112", deviceId:"251C", inClusters:"0x5E,0x6C,0x55,0x9F", deviceJoinName:"Zooz ZEN24 Dimmer"
	}
...
void zwaveEvent(hubitat.zwave.commands.centralscenev3.CentralSceneNotification cmd){
	if (state.lastSequenceNumber != cmd.sequenceNumber) {
		...
		// ZEN22/ZEN27 on certain firmware - need to flip the sceneNumber due to bug
